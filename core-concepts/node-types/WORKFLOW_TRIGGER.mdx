...
Workflow Triggers are the fundamental starting point of every workflow in Orka. It defines how and when a workflow is initiated, serving as the entry point that determines the execution context and scheduling behavior.

## What are Workflow Triggers?

Workflow Triggers are special workflow components that:

* Always appear first in workflow definitions
* Define the execution method (manual, form-based, or scheduled)
